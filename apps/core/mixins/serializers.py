...
class DynamicFieldsModelSerializer(ModelSerializer, DynamicFieldsSerializer):
    ...
    def get_fields(self):
        ...
        if self.request and self.request.method == 'GET':
            fields = self.update_get_fields(fields=fields)
        return fields
...
class CustomerCommonSerializerMixin(DynamicFieldsModelSerializer):

    def create(self, validated_data):
        validated_data['customer'] = self.customer_instance
